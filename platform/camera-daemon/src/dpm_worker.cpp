...
// parse_yolo_grid (neoruntime-apps/showcases/parking-lot/parking_lot/postprocess.py:238 and
// neoruntime-apps/showcases/model-showcase/main.py:2927) — identical anchors, thresholds, NMS.
// Source of truth for anchors: neoruntime-apps/showcases/parking-lot/parking_lot/config.py:135-140.
struct Yv4GridSpec {
    uint32_t grid_h;
    uint32_t grid_w;
