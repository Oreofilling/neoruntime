...
[`./os-upgrade.md`](/project/deployment/os-upgrade.md) for the required image contents.
...
See [`../getting-started/BUILD.md`](/project/getting-started/build.md) for the full
layer-3 SDK setup.
