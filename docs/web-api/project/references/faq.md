...
git clone git@github.com:camthink-ai/neoruntime-sdks.git
...
1. Read [`CONTRIBUTING.md`](https://github.com/camthink-ai/neoruntime/blob/main/CONTRIBUTING.md).
2. Fork the project or create a branch from the latest `main`.
3. Use a separate feature branch for functional changes.
4. Write tests or record manual verification.
