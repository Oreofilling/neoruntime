...
- [HAL v2 API Reference](/project/references/hal-v2-api-reference.md)
- [REST API Reference (Swagger)](https://github.com/camthink-ai/neoruntime/blob/main/docs/api/swagger.yaml)
- [MCU Communication Protocol](/project/mcu_protocol/readme.md)
