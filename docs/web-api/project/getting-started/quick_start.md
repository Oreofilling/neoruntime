...
**Windows users:** See [WINDOWS_SETUP.md](/project/getting-started/windows_setup.md) for detailed instructions.
...
1. [Build Guide](/project/getting-started/build.md) - Detailed build instructions
2. [Architecture](/project/architecture/readme.md) - System architecture
3. [HAL v2 API Reference](/project/references/hal-v2-api-reference.md) - Hardware abstraction interfaces
4. SDK and app development guides live in `camthink-ai/neoruntime-sdks` and `camthink-ai/neoruntime-apps`
